...
#ifndef TENSORFLOW_LITE_UTIL_DENSE_MODEL_DATA_H_
#define TENSORFLOW_LITE_UTIL_DENSE_MODEL_DATA_H_

extern const unsigned char dense_model[];
extern const int dense_model_len;

#endif  // TENSORFLOW_LITE_UTIL_DENSE_MODEL_DATA_H_
